...
import { $fetch as $fetch$1 } from "/Users/poj/innovation-awards/testing-project/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/poj/innovation-awards/testing-project/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/poj/innovation-awards/testing-project/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, setCookie, getHeader } from "/Users/poj/innovation-awards/testing-project/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu, defuFn } from "/Users/poj/innovation-awards/testing-project/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "/Users/poj/innovation-awards/testing-project/node_modules/ufo/dist/index.mjs";
import { createServerClient, parseCookieHeader } from "@supabase/ssr";
import { _api, addAPIProvider, setCustomIconsLoader } from "@iconify/vue";
import { klona } from "/Users/poj/innovation-awards/testing-project/node_modules/klona/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-MfQQgrg6.js")
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-dywHJmwk.js")
  },
  {
    name: "pia-submit",
    path: "/pia/submit",
    component: () => import("./_nuxt/submit-SXtYKlig.js")
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-9ZQxBmmi.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-IiH2bsPd.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DkPyu_YZ.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DKEGPg8M.js"));
