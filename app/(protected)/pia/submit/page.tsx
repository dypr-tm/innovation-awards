    ...
    <div className="pt-12 pb-24 bg-gray-50/50 min-h-screen">
      <section className="container mx-auto px-6 max-w-4xl">
        <div className="mb-10 text-center">
          <h1 className="text-3xl md:text-4xl font-extrabold text-pegadaian-navy tracking-tight mb-4">
        ...
        <div className="bg-white rounded-3xl pegadaian-shadow p-8 md:p-12">
          <form className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                ...
                <select className="w-full px-5 py-3.5 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-pegadaian-gold transition-all text-gray-800 appearance-none">
            ...
            <div className="border-t border-gray-100 pt-8 mt-8 flex justify-end gap-4">
              <button 
                type="button" 
                className="px-6 py-3.5 rounded-xl bg-white border border-gray-200 text-gray-700 font-semibold hover:bg-gray-50 transition-all text-sm"
              >
                Simpan Draft
              </button>
              <button 
                type="button" 
                className="px-8 py-3.5 rounded-xl bg-pegadaian-gold text-pegadaian-navy hover:bg-yellow-500 font-bold shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 text-sm"
              >
                Kirim & Evaluasi AI ✨
              </button>
            </div>
