          ...
          <form className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                ...
                <select className="w-full px-6 py-4 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-pegadaian-yellow transition-all text-gray-800 appearance-none">
            ...
            <div className="border-t border-gray-100 pt-8 mt-8 flex justify-end gap-4">
              <button 
                type="button" 
                className="px-6 py-4 rounded-xl bg-white border border-gray-200 text-gray-700 font-semibold hover:bg-gray-50 transition-all text-sm"
              >
                Simpan Draft
              </button>
              <button 
                type="button" 
                className="px-8 py-4 rounded-xl bg-pegadaian-yellow text-pegadaian-green hover:opacity-90 font-bold shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 text-sm"
              >
                Kirim & Evaluasi AI ✨
              </button>
            </div>
