import { MdCheckCircle, MdElectricBolt, MdSettings, MdSecurity } from "react-icons/md";
        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <div>
                <h3 className="text-xl font-bold text-pegadaian-green mb-2">Teknologi</h3>
            ...
            <div className="flex items-start gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <div>
                <h3 className="text-xl font-bold text-pegadaian-green mb-2">Layanan & Produk</h3>
            ...
            <div className="flex items-start gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <div>
                <h3 className="text-xl font-bold text-pegadaian-green mb-2">Proses Bisnis</h3>
