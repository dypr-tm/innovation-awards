  ...
  return (
    <div className="pt-12 pb-24 bg-gray-50/50 min-h-screen">
      ...
      <section className="container mx-auto px-6 max-w-5xl text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-extrabold text-pegadaian-navy tracking-tight leading-tight mb-4">
          Mari Berkolaborasi!
        </h1>
      ...
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="w-full lg:w-1/3 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl pegadaian-shadow border border-gray-100 flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:innovation@pegadaian.co.id" className="text-gray-600 text-sm hover:text-pegadaian-navy hover:underline">innovation@pegadaian.co.id</a>
              </div>
            </div>
          ...
          {/* Formulir Kontak */}
          <div className="w-full lg:w-2/3 bg-white p-8 md:p-10 rounded-3xl pegadaian-shadow border border-gray-100">
            <h2 className="text-2xl font-bold text-pegadaian-navy mb-8">Kirim Pesan Langsung</h2>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <select className="w-full px-5 py-3.5 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-pegadaian-gold transition-all text-gray-800 appearance-none pr-10">
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full px-5 py-3.5 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-pegadaian-gold transition-all text-gray-800 resize-none"
                ></textarea>
              </div>

              <button 
                type="button" 
                className="w-full py-4 bg-pegadaian-navy hover:bg-pegadaian-dark text-white font-bold text-lg rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 active:scale-95"
              >
                Kirim Pesan
              </button>
            </form>
