    ...
    <div className="w-full relative bg-gray-50/30 overflow-x-hidden">
      ...
      <section className="pt-20 pb-24 px-6 relative">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <a href="/repository" className="inline-block px-8 py-4 bg-pegadaian-green text-white font-bold rounded-2xl shadow-xl hover:shadow-2xl hover:opacity-90 transition-all transform hover:-translate-y-1 active:scale-95 text-lg">
            Lihat Inovasi
          </a>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 mb-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-8 rounded-3xl pegadaian-shadow text-center transform transition-transform hover:-translate-y-2">
