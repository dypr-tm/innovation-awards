import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, toRef, isRef, defineAsyncComponent, defineComponent, h, inject, computed, unref, shallowRef, provide, shallowReactive, createElementBlock, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { f as createError$1, k as parseURL, l as encodePath, m as decodePath, n as hasProtocol, o as isScriptProtocol, j as joinURL, w as withQuery, q as klona, s as sanitizeStatusCode, t as getContext, v as defuFn, $ as $fetch$1, x as baseURL, y as defu, z as createHooks, A as executeAsync, B as getHeader, C as setCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-MfQQgrg6.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-dywHJmwk.mjs')
  },
  {
    name: "pia-submit",
    path: "/pia/submit",
    component: () => import('./submit-SXtYKlig.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-9ZQxBmmi.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-IiH2bsPd.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DkPyu_YZ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DKEGPg8M.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, asyncDataDefaults as c, createError as d, entry_default as default, useSupabaseUser as e, useRouter as f, encodeRoutePath as g, nuxtLinkDefaults as h, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useAppConfig as u };
